...
//		void BeginScene(const Camera& camera, const EnvironmentEntity& environment, const RenderSettings& renderSettings);
//
...
//		std::shared_ptr<ITexture> m_Texture, m_SkyboxTexture;
