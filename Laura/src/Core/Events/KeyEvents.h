...
namespace Laura 
{
	...
	struct KeyPressEvent : public IEvent {
    	...
    	KeyPressEvent(KeyCode k, bool ctrl, bool shift, bool alt, bool super)
	...
	struct KeyReleaseEvent : public IEvent {
    	...
    	KeyReleaseEvent(KeyCode k, bool ctrl, bool shift, bool alt, bool super)
        	: key(k), keyCtrl(ctrl), keyShift(shift), keyAlt(alt), keySuper(super) {}
	...
	struct KeyRepeatEvent : public IEvent {
    	...
    	KeyRepeatEvent(KeyCode k, bool ctrl, bool shift, bool alt, bool super)
        	: key(k), keyCtrl(ctrl), keyShift(shift), keyAlt(alt), keySuper(super) {}
